...
- 🎯 1-ый тест локальной ИИ на ноуте [16 ГБ оперативы] (Ollama,Web UI,Open code: qwen2.5-1.0 - шляпа полная, chat gpt посоветовал очень устаревшую).
Вышел новый qwen3.8 - будем тестить.
